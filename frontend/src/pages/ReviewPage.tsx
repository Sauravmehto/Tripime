...
export function ReviewPage() {
  ...
  return (
    <Layout>
      <h1 className="mb-2 text-2xl font-bold text-neutral-900 sm:text-3xl">Review booking</h1>
      <p className="mb-6 text-sm text-neutral-600">
        Confirm your trip details, then continue to seat selection. No booking is created yet.
      </p>
      ...
      <Button size="lg" className="mt-6 w-full sm:w-auto" onClick={() => void handleConfirmContinue()}>
        Confirm &amp; continue
      </Button>
    </Layout>
  );
